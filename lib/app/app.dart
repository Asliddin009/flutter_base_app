...
import 'package:flutter_base_app/di/app_depends.dart';
import 'package:flutter_base_app/di/app_depends_provider.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppDependsProvider(
      ...
      child: BlocProvider(
        create: (context) =>
            AuthBloc(depends.authRepo, depends.secureStorage)
              ..add(AuthEventInit()),
